<template>
    ...
    <div class="container">
      ...
      <div class="row" data-animate="fadeInUp">
        <div class="col-lg-12">
          <img
            class="img-fluid"
            src="../assets/images/other/responsive-1.jpg"
            alt="Welcome to POLO"
          />
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div data-animate="fadeInUp" data-animate-delay="0">
            <h4>Modern Design</h4>
            <p>
              Lorem ipsum dolor sit amet, blandit vel sapien vitae, condimentum
    ...
    <div class="container">
      <div class="heading-text heading-section">
        ...
        <span class="lead"
          ...
          feugiat nulla facilisis at vero eros et accumsan et iusto.</span
        >
      </div>
    </div>
    <div class="portfolio">
      ...
      >
        ...
        >
          <div class="portfolio-item-wrap">
            <div class="portfolio-slider">
              ...
              >
                <a href="#"
                  ><img src="../assets/images/portfolio/64.jpg" alt=""
                /></a>
                <a href="#"
          ...
          <div class="portfolio-item-wrap">
            ...
            <div class="portfolio-description">
              <a
                title="Paper Pouch!"
                data-lightbox="image"
                href="../assets/images/portfolio/83l.jpg"
        ...
        >
          <div class="portfolio-item-wrap">
            <div class="portfolio-image">
              <a href="#"
                ><img src="../assets/images/portfolio/65.jpg" alt=""
              /></a>
            </div>
            <div class="portfolio-description" data-lightbox="gallery">
              <a
                title="Photoshop Mock-up!"
                data-lightbox="gallery-image"
                href="../assets/images/portfolio/80l.jpg"
                ><i class="icon-copy"></i
              ></a>
              <a
                title="Paper Pouch!"
                data-lightbox="gallery-image"
                href="../assets/images/portfolio/81l.jpg"
                class="hidden"
              ></a>
              <a
                title="Mock-up"
                data-lightbox="gallery-image"
                href="../assets/images/portfolio/82l.jpg"
                class="hidden"
              ></a>
              <a href="portfolio-page-grid-gallery.html"
                ><i class="icon-link"></i
        ...
        >
          <div class="portfolio-item-wrap">
            <div class="portfolio-image">
              <a href="#"
                ><img src="../assets/images/portfolio/66.jpg" alt=""
              /></a>
            </div>
            <div class="portfolio-description">
              <a href="portfolio-page-grid-gallery.html">
        ...
        >
          <div class="portfolio-item-wrap">
            <div class="portfolio-image">
              <a href="#"
                ><img src="../assets/images/portfolio/67.jpg" alt=""
              /></a>
            </div>
            <div class="portfolio-description">
              <a
        ...
        >
          <div class="portfolio-item-wrap">
            <div class="portfolio-slider">
              ...
              >
                <a href="#"
                  ><img src="../assets/images/portfolio/68.jpg" alt=""
                /></a>
                <a href="#"
                  ><img src="../assets/images/portfolio/71.jpg" alt=""
                /></a>
              </div>
            </div>
          </div>
  ...
  <!-- COUNTERS -->
  <section
    class="text-light p-t-150 p-b-150"
    data-bg-parallax="../assets/images/parallax/12.jpg"
  >
    ...
    <div class="container">
      <div class="heading-text heading-section">
        ...
        <span class="lead"
          ...
          faucibus, orci ipsum gravida tortor, vel interdum mi sapien ut justo.
          Nulla varius consequat magna, id molestie ipsum volutpat quis. A true
          story, that never been told!. Fusce id mi diam, non ornare orci.
      ...
      >
          ...
          <div class="post-item-wrap">
            ...
            <div class="post-item-description">
              ...
              <p>
                ...
                Vivamus luctus commodo dolor porta feugiat. Fusce at velit id
                ligula pharetra laoreet.
              </p>
        ...
        <div class="post-item border">
          <div class="post-item-wrap">
            <div class="post-image">
              <a href="#">
                <img alt="" src="../assets/images/blog/18.jpg" />
              </a>
              <span class="post-meta-category"><a href="">Science</a></span>
            </div>
            <div class="post-item-description">
